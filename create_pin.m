...
air_mat_ID       = 6;
alu_mat_ID       = 7;
detector_mat_ID  = 8; % water inside in the MCNP input
pneumatic_mat_ID = 9; 
pneu_clad_mat_ID = 10; % small and large pneumatics clads are Aluminium 
source_mat_ID    = 11; % air or water
% densities
...
pneumatic_density     = 1.0E-05;
pneu_clad_mat_density = -2.7; % aluminium
source_density        = 1.0E-05;
detector_density      = -0.10004; % water_density 
% radii
