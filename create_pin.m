...
switch pin_type
    ...
    case 'fuel-followed_control_rod'
        ...
        surf_ID=surf_ID+1; % increment surface ID
        % write new cylinder surface in file_handle_surf
        fprint(file_handle_surf,'%5d   C/Z %g %g %g /n', surf_ID,x_center,y_center,radius_zr_rod);
        ...
        surf_ID=surf_ID+1; % increment surface ID
        % write new cylinder surface in file_handle_surf
        fprint(file_handle_surf,'%5d   C/Z %g %g %g /n', surf_ID,x_center,y_center,radius_fuel_meat);
        cell_ID=celle_ID+1; % increment cell ID
        ...
        surf_ID=surf_ID+1; % increment surface ID
        % write new cylinder surface in file_handle_surf
        fprint(file_handle_surf,'%5d   C/Z %g %g %g /n', surf_ID,x_center,y_center,radius_clad);
        cell_ID=celle_ID+1; % increment cell ID
        % write new celle in file_handle_cell
