...
bundle_type{2,2}='regulating_bundle';
bundle_type{1,2}='transient_bundle';
bundle_type{1,1}='water_hole';
% put shim_bundle
index_i= [ 4 4 6 6 ];
index_j= [ 3 5 3 5 ];
...
for i=1:max_row
    for j=1:max_col
        [cell_ID, surf_ID]  = create_bundle(x_bundle_center, y_bundle_center, bundle_type, cell_ID, surf_ID, file_handle_cell, file_handle_surf)
